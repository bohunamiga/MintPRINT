...
int query_printer_attributes(const char *ip, int port, char *response, int maxlen) {
    ...
    const char *requested = "media-source-supported,media-ready,printer-input-tray,printer-state,print-color-mode-supported,print-scaling-supported";
                ...
                case IDCMP_GADGETUP:
                    switch (gad->GadgetID) {
                        ...
                        case GAD_PRINT_BUTTON:
                        {
                            ...
                            send_print_job(ip_only, port, file_buffer, media_str, selected_print_mode);
                        }
                        break;

...
int rgb_to_ycbcr(jpeg_data* data)
{
	...
	for (i=0; i<data->num_pixel; i++)
	{
		data->y[i]  = (int)(  0.299    * data->red[i] + 0.587    * data->green[i] + 0.114    * data->blue[i] + 0.5 );
		data->cb[i] = (int)(128 - 0.168736 * data->red[i] - 0.331264 * data->green[i] + 0.5      * data->blue[i] + 0.5 );
		data->cr[i] = (int)(128 + 0.5      * data->red[i] - 0.418688 * data->green[i] - 0.081312 * data->blue[i] + 0.5 );
